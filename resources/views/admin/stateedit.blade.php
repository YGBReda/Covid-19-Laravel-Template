...
<form class="uk-form-stacked " action="{{ url('state/'.$statedata->id) }}" method="post" enctype="multipart/form-data">
...
{{ csrf_field() }}
    ...
    <div class="uk-margin uk-form-width-large">
        ...
        <div class="uk-form-controls">
            <select class="uk-select" id="country" name="Country">
               <option  selected>{{ $statedata->Country}}</option>
        ...
        <div class="uk-form-controls">
            <select class="uk-select" id="State" name="state">
              <option  selected>{{ $statedata->name}}</option>
    ...
    <div class="uk-margin uk-form-width-large">
        ...
        <div class="uk-form-controls">
            <input name="Confirmed" class="uk-input" type="number" placeholder="1" value="{{ $statedata->Confirmed}}">
        </div>
    </div>
    ...
    <div class="uk-margin uk-form-width-large">
        ...
        <div class="uk-form-controls">
            <input name="Deaths" class="uk-input" type="number" placeholder="1" value="{{ $statedata->Deaths}}">
        </div>
    </div>
    ...
    <div class="uk-margin uk-form-width-large">
        ...
        <div class="uk-form-controls">
            <input name="Recovered" class="uk-input" type="number" placeholder="1" value="{{ $statedata->Recovered}}">
        </div>
    </div>
