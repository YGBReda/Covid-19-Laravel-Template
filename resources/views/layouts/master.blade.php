...
<script src="https://www.amcharts.com/lib/4/geodata/algeriaLow.js"></script>-->
...
<nav class=" uk-margin menu-top ">
    ...
    <button class="uk-button uk-button-default" type="button">Language <span  uk-icon="chevron-down"></span>
</button>
    <div uk-dropdown>
...
<div class="uk-margin uk-form-width-large ">
        <label class="uk-form-label " for="form-horizontal-select">Country</label>
