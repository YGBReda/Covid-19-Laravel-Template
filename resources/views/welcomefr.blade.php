...
<div class="uk-text-center" uk-grid>
    <div class="uk-width-auto@m uk-text-left sidebar-left uk-background-muted">
        <ul class="uk-list uk-list-divider" id="datalist">
			    <li style="color: #00a8ff ;">Confirmés : {{$total->Confirmed}}</li>
			    <li style="color: #27ae60;">Rétablis : {{$total->Recovered}}</li>
			    <li style="color: #d63031;">Décédés : {{$total->Deaths}}</li>
          <li style="color: #555 ;font-size: 12px;padding-top: 17px;">Mise-à-J : {{$total->updated_at}}</li>
...
$(".select-state").empty();
$("#datalist").empty();
 $("#datalist").append('<li style="color: #00a8ff ;">Confirmés : '+confirmed_s+'</li>');
 $("#datalist").append('<li style="color: #27ae60 ;">Rétablis : '+recovered_s+'</li>');
  $("#datalist").append('<li style="color: #EE5A24 ;">Quarantine : '+quarantine+'</li>');
 $("#datalist").append('<li style="color: #d63031 ;">Décédés : '+deaths_s+'</li>');
 $("#datalist").append('<li style="color: #555 ;font-size: 12px;padding-top: 17px;">Mise-à-J : '+lastupdate+'</li>');
...
$("#datalist").empty();
 $("#datalist").append('<li style="color: #00a8ff ;">Confirmés : '+confirmed_s+'</li>');
 $("#datalist").append('<li style="color: #27ae60 ;">Rétablit : '+recovered_s+'</li>');
  $("#datalist").append('<li style="color: #EE5A24 ;">Quarantaine : '+quarantine+'</li>');
 $("#datalist").append('<li style="color: #d63031 ;">Décédés : '+deaths_s+'</li>');
$("#datalist").append('<li style="color: #555 ;font-size: 12px;padding-top: 17px;">Mise-à-J : '+lastupdate+'</li>');
...
chart.legend = new am4charts.Legend();
  ...
  $(".select-state").empty();
  $(".select-state").append('<label class="uk-form-label " for="form-stacked-select">Wilaya</label><div class="uk-form-controls"><select class="uk-select" id="State" name="state"><option>Séléctionner la wilaya </option>@foreach($statesharedz as $statesharedz)<option>{{$statesharedz->name}}</option>@endforeach</select></div>');
...
$(".select-state").empty();
 $("#datalist").empty();
 $("#datalist").append('<li style="color: #00a8ff ;">Confirmés : {{$total_confirmed}}</li>');
 $("#datalist").append('<li style="color: #27ae60 ;">Rétablit : {{$total_recovered}}</li>');
 $("#datalist").append('<li style="color: #d63031 ;">Décédés : {{$total_deaths}}</li>');
  $("#datalist").append('<li style="color: #555 ;font-size: 12px;padding-top: 17px;">Mise-à-J : '+lastupdate+'</li>');          
            }
...
//title.textAlign = "middle";
   mapData = [
  { "id":"AF", "name":"Afghanistan", "value":parseFloat(confirmed[0]), "color": chart.colors.getIndex(0) },
  { "id":"AL", "name":"Albania", "value":parseFloat(confirmed[1]), "color":chart.colors.getIndex(1) },
  { "id":"DZ", "name":"Algeria", "value":parseFloat(confirmed[2]), "color":chart.colors.getIndex(2) },
  { "id":"AO", "name":"Angola", "value":parseFloat(confirmed[5]), "color":chart.colors.getIndex(2) },
  { "id":"AR", "name":"Argentina", "value":parseFloat(confirmed[9]), "color":chart.colors.getIndex(3) },
  { "id":"AM", "name":"Armenia", "value":parseFloat(confirmed[10]), "color":chart.colors.getIndex(1) },
  { "id":"AU", "name":"Australia", "value":parseFloat(confirmed[12]), "color":"#8aabb0" },
  { "id":"AT", "name":"Austria", "value":parseFloat(confirmed[13]), "color":chart.colors.getIndex(1) },
  { "id":"AZ", "name":"Azerbaijan", "value":parseFloat(confirmed[14]), "color":chart.colors.getIndex(1) },
  { "id":"BH", "name":"Bahrain", "value":parseFloat(confirmed[16]), "color": chart.colors.getIndex(0) },
  { "id":"BD", "name":"Bangladesh", "value":parseFloat(confirmed[17]), "color": chart.colors.getIndex(0) },
  { "id":"BY", "name":"Belarus", "value":parseFloat(confirmed[19]), "color":chart.colors.getIndex(1) },
  { "id":"BE", "name":"Belgium", "value":parseFloat(confirmed[20]), "color":chart.colors.getIndex(1) },
  { "id":"BJ", "name":"Benin", "value":parseFloat(confirmed[22]), "color":chart.colors.getIndex(2) },
  { "id":"BT", "name":"Bhutan", "value":parseFloat(confirmed[24]), "color": chart.colors.getIndex(0) },
  { "id":"BO", "name":"Bolivia", "value":parseFloat(confirmed[25]), "color":chart.colors.getIndex(3) },
  { "id":"BA", "name":"Bosnia and Herzegovina", "value":parseFloat(confirmed[26]), "color":chart.colors.getIndex(1) },
  { "id":"BW", "name":"Botswana", "value":parseFloat(confirmed[27]), "color":chart.colors.getIndex(2) },
  { "id":"BR", "name":"Brazil", "value":parseFloat(confirmed[29]), "color":chart.colors.getIndex(3) },
  { "id":"BN", "name":"Brunei", "value":parseFloat(confirmed[31]), "color": chart.colors.getIndex(0) },
  { "id":"BG", "name":"Bulgaria", "value":parseFloat(confirmed[32]), "color":chart.colors.getIndex(1) },
  { "id":"BF", "name":"Burkina Faso", "value":parseFloat(confirmed[33]), "color":chart.colors.getIndex(2) },
  { "id":"BI", "name":"Burundi", "value":parseFloat(confirmed[34]), "color":chart.colors.getIndex(2) },
  { "id":"KH", "name":"Cambodia", "value":parseFloat(confirmed[23]), "color": chart.colors.getIndex(0) },
  { "id":"CM", "name":"Cameroon", "value":parseFloat(confirmed[36]), "color":chart.colors.getIndex(2) },
  { "id":"CA", "name":"Canada", "value":parseFloat(confirmed[37]), "color":chart.colors.getIndex(4) },
  { "id":"CV", "name":"Cape Verde", "value":parseFloat(confirmed[38]), "color":chart.colors.getIndex(2) },
  { "id":"CF", "name":"Central African Rep.", "value":parseFloat(confirmed[40]), "color":chart.colors.getIndex(2) },
  { "id":"TD", "name":"Chad", "value":parseFloat(confirmed[41]), "color":chart.colors.getIndex(2) },
  { "id":"CL", "name":"Chile", "value":parseFloat(confirmed[42]), "color":chart.colors.getIndex(3) },
  { "id":"CN", "name":"China", "value":parseFloat(confirmed[43]), "color": chart.colors.getIndex(0) },
  { "id":"CO", "name":"Colombia", "value":parseFloat(confirmed[46]), "color":chart.colors.getIndex(3) },
  { "id":"KM", "name":"Comoros", "value":parseFloat(confirmed[47]), "color":chart.colors.getIndex(2) },
  { "id":"CD", "name":"Congo, Dem. Rep.", "value":parseFloat(confirmed[48]), "color":chart.colors.getIndex(2) },
  { "id":"CG", "name":"Congo, Rep.", "value":parseFloat(confirmed[49]), "color":chart.colors.getIndex(2) },
  { "id":"CR", "name":"Costa Rica", "value":parseFloat(confirmed[51]), "color":chart.colors.getIndex(4) },
  { "id":"CI", "name":"Cote d'Ivoire", "value":parseFloat(confirmed[52]), "color":chart.colors.getIndex(2) },
  { "id":"HR", "name":"Croatia", "value":parseFloat(confirmed[53]), "color":chart.colors.getIndex(1) },
  { "id":"CU", "name":"Cuba", "value":parseFloat(confirmed[54]), "color":chart.colors.getIndex(4) },
  { "id":"CY", "name":"Cyprus", "value":parseFloat(confirmed[55]), "color":chart.colors.getIndex(1) },
  { "id":"CZ", "name":"Czech Rep.", "value":parseFloat(confirmed[56]), "color":chart.colors.getIndex(1) },
  { "id":"DK", "name":"Denmark", "value":parseFloat(confirmed[57]), "color":chart.colors.getIndex(1) },
  { "id":"DJ", "name":"Djibouti", "value":parseFloat(confirmed[58]), "color":chart.colors.getIndex(2) },
  { "id":"DO", "name":"Dominican Rep.", "value":parseFloat(confirmed[60]), "color":chart.colors.getIndex(4) },
  { "id":"EC", "name":"Ecuador", "value":parseFloat(confirmed[61]), "color":chart.colors.getIndex(3) },
  { "id":"EG", "name":"Egypt", "value":parseFloat(confirmed[62]), "color":chart.colors.getIndex(2) },
  { "id":"SV", "name":"El Salvador", "value":parseFloat(confirmed[63]), "color":chart.colors.getIndex(4) },
  { "id":"GQ", "name":"Equatorial Guinea", "value":parseFloat(confirmed[64]), "color":chart.colors.getIndex(2) },
  { "id":"ER", "name":"Eritrea", "value":parseFloat(confirmed[65]), "color":chart.colors.getIndex(2) },
  { "id":"EE", "name":"Estonia", "value":parseFloat(confirmed[66]), "color":chart.colors.getIndex(1) },
  { "id":"ET", "name":"Ethiopia", "value":parseFloat(confirmed[67]), "color":chart.colors.getIndex(2) },
  { "id":"FJ", "name":"Fiji", "value":parseFloat(confirmed[70]), "color":"#8aabb0" },
  { "id":"FI", "name":"Finland", "value":parseFloat(confirmed[71]), "color":chart.colors.getIndex(1) },
  { "id":"FR", "name":"France", "value":parseFloat(confirmed[72]), "color":chart.colors.getIndex(1) },
  { "id":"GA", "name":"Gabon", "value":parseFloat(confirmed[76]), "color":chart.colors.getIndex(2) },
  { "id":"GM", "name":"Gambia", "value":parseFloat(confirmed[77]), "color":chart.colors.getIndex(2) },
  { "id":"GE", "name":"Georgia", "value":parseFloat(confirmed[78]), "color":chart.colors.getIndex(1) },
  { "id":"DE", "name":"Germany", "value":parseFloat(confirmed[79]), "color":chart.colors.getIndex(1) },
  { "id":"GH", "name":"Ghana", "value":parseFloat(confirmed[80]), "color":chart.colors.getIndex(2) },
  { "id":"GR", "name":"Greece", "value":parseFloat(confirmed[82]), "color":chart.colors.getIndex(1) },
  { "id":"GT", "name":"Guatemala", "value":parseFloat(confirmed[87]), "color":chart.colors.getIndex(4) },
  { "id":"GN", "name":"Guinea", "value":parseFloat(confirmed[88]), "color":chart.colors.getIndex(2) },
  { "id":"GW", "name":"Guinea-Bissau", "value":parseFloat(confirmed[89]), "color":chart.colors.getIndex(2) },
  { "id":"GY", "name":"Guyana", "value":parseFloat(confirmed[90]), "color":chart.colors.getIndex(3) },
  { "id":"HT", "name":"Haiti", "value":parseFloat(confirmed[91]), "color":chart.colors.getIndex(4) },
  { "id":"HN", "name":"Honduras", "value":parseFloat(confirmed[94]), "color":chart.colors.getIndex(4) },
  { "id":"HK", "name":"Hong Kong, China", "value":parseFloat(confirmed[95]), "color": chart.colors.getIndex(0) },
  { "id":"HU", "name":"Hungary", "value":parseFloat(confirmed[96]), "color":chart.colors.getIndex(1) },
  { "id":"IS", "name":"Iceland", "value":parseFloat(confirmed[97]), "color":chart.colors.getIndex(1) },
  { "id":"IN", "name":"India", "value":parseFloat(confirmed[98]), "color": chart.colors.getIndex(0) },
  { "id":"ID", "name":"Indonesia", "value":parseFloat(confirmed[99]), "color": chart.colors.getIndex(0) },
  { "id":"IR", "name":"Iran", "value":parseFloat(confirmed[100]), "color": chart.colors.getIndex(0) },
  { "id":"IQ", "name":"Iraq", "value":parseFloat(confirmed[101]), "color": chart.colors.getIndex(0) },
  { "id":"IE", "name":"Ireland", "value":parseFloat(confirmed[102]), "color":chart.colors.getIndex(1) },
  { "id":"IL", "name":"Israel", "value":parseFloat(confirmed[103]), "color": chart.colors.getIndex(0) },
  { "id":"IT", "name":"Italy", "value":parseFloat(confirmed[104]), "color":chart.colors.getIndex(1) },
  { "id":"JM", "name":"Jamaica", "value":parseFloat(confirmed[105]), "color":chart.colors.getIndex(4) },
  { "id":"JP", "name":"Japan", "value":parseFloat(confirmed[106]), "color": chart.colors.getIndex(0) },
  { "id":"JO", "name":"Jordan", "value":parseFloat(confirmed[107]), "color": chart.colors.getIndex(0) },
  { "id":"KZ", "name":"Kazakhstan", "value":parseFloat(confirmed[108]), "color": chart.colors.getIndex(0) },
  { "id":"KE", "name":"Kenya", "value":parseFloat(confirmed[109]), "color":chart.colors.getIndex(2) },
  { "id":"KP", "name":"Korea, Dem. Rep.", "value":parseFloat(confirmed[111]), "color": chart.colors.getIndex(0) },
  { "id":"KR", "name":"Korea, Rep.", "value":parseFloat(confirmed[112]), "color": chart.colors.getIndex(0) },
  { "id":"KW", "name":"Kuwait", "value":parseFloat(confirmed[113]), "color": chart.colors.getIndex(0) },
  { "id":"KG", "name":"Kyrgyzstan", "value":parseFloat(confirmed[114]), "color": chart.colors.getIndex(0) },
  { "id":"LA", "name":"Laos", "value":parseFloat(confirmed[115]), "color": chart.colors.getIndex(0) },
  { "id":"LV", "name":"Latvia", "value":parseFloat(confirmed[116]), "color":chart.colors.getIndex(1) },
  { "id":"LB", "name":"Lebanon", "value":parseFloat(confirmed[117]), "color": chart.colors.getIndex(0) },
  { "id":"LS", "name":"Lesotho", "value":parseFloat(confirmed[118]), "color":chart.colors.getIndex(2) },
  { "id":"LR", "name":"Liberia", "value":parseFloat(confirmed[119]), "color":chart.colors.getIndex(2) },
  { "id":"LY", "name":"Libya", "value":parseFloat(confirmed[120]), "color":chart.colors.getIndex(2) },
  { "id":"LT", "name":"Lithuania", "value":parseFloat(confirmed[122]), "color":chart.colors.getIndex(1) },
  { "id":"LU", "name":"Luxembourg", "value":parseFloat(confirmed[123]), "color":chart.colors.getIndex(1) },
  { "id":"MK", "name":"Macedonia, FYR", "value":parseFloat(confirmed[125]), "color":chart.colors.getIndex(1) },
  { "id":"MG", "name":"Madagascar", "value":parseFloat(confirmed[126]), "color":chart.colors.getIndex(2) },
  { "id":"MW", "name":"Malawi", "value":parseFloat(confirmed[127]), "color":chart.colors.getIndex(2) },
  { "id":"MY", "name":"Malaysia", "value":parseFloat(confirmed[128]), "color": chart.colors.getIndex(0) },
  { "id":"ML", "name":"Mali", "value":parseFloat(confirmed[130]), "color":chart.colors.getIndex(2) },
  { "id":"MR", "name":"Mauritania", "value":parseFloat(confirmed[134]), "color":chart.colors.getIndex(2) },
  { "id":"MU", "name":"Mauritius", "value":parseFloat(confirmed[135]), "color":chart.colors.getIndex(2) },
  { "id":"MX", "name":"Mexico", "value":parseFloat(confirmed[137]), "color":chart.colors.getIndex(4) },
  { "id":"MD", "name":"Moldova", "value":parseFloat(confirmed[139]), "color":chart.colors.getIndex(1) },
  { "id":"MN", "name":"Mongolia", "value":parseFloat(confirmed[141]), "color": chart.colors.getIndex(0) },
  { "id":"ME", "name":"Montenegro", "value":0, "color":chart.colors.getIndex(1) },
  { "id":"MA", "name":"Morocco", "value":parseFloat(confirmed[143]), "color":chart.colors.getIndex(2) },
  { "id":"MZ", "name":"Mozambique", "value":parseFloat(confirmed[144]), "color":chart.colors.getIndex(2) },
  { "id":"MM", "name":"Myanmar", "value":parseFloat(confirmed[145]), "color": chart.colors.getIndex(0) },
  { "id":"NA", "name":"Namibia", "value":parseFloat(confirmed[146]), "color":chart.colors.getIndex(2) },
  { "id":"NP", "name":"Nepal", "value":parseFloat(confirmed[148]), "color": chart.colors.getIndex(0) },
  { "id":"NL", "name":"Netherlands", "value":parseFloat(confirmed[149]), "color":chart.colors.getIndex(1) },
  { "id":"NZ", "name":"New Zealand", "value":parseFloat(confirmed[152]), "color":"#8aabb0" },
  { "id":"NI", "name":"Nicaragua", "value":parseFloat(confirmed[153]), "color":chart.colors.getIndex(4) },
  { "id":"NE", "name":"Niger", "value":parseFloat(confirmed[154]), "color":chart.colors.getIndex(2) },
  { "id":"NG", "name":"Nigeria", "value":parseFloat(confirmed[155]), "color":chart.colors.getIndex(2) },
  { "id":"NO", "name":"Norway", "value":parseFloat(confirmed[159]), "color":chart.colors.getIndex(1) },
  { "id":"OM", "name":"Oman", "value":parseFloat(confirmed[160]), "color": chart.colors.getIndex(0) },
  { "id":"PK", "name":"Pakistan", "value":parseFloat(confirmed[161]), "color": chart.colors.getIndex(0) },
  { "id":"PA", "name":"Panama", "value":parseFloat(confirmed[164]), "color":chart.colors.getIndex(4) },
  { "id":"PG", "name":"Papua New Guinea", "value":parseFloat(confirmed[165]), "color":"#8aabb0" },
  { "id":"PY", "name":"Paraguay", "value":parseFloat(confirmed[166]), "color":chart.colors.getIndex(3) },
  { "id":"PE", "name":"Peru", "value":parseFloat(confirmed[167]), "color":chart.colors.getIndex(3) },
  { "id":"PH", "name":"Philippines", "value":parseFloat(confirmed[168]), "color": chart.colors.getIndex(0) },
  { "id":"PL", "name":"Poland", "value":parseFloat(confirmed[170]), "color":chart.colors.getIndex(1) },
  { "id":"PT", "name":"Portugal", "value":parseFloat(confirmed[171]), "color":chart.colors.getIndex(1) },
  { "id":"PR", "name":"Puerto Rico", "value":parseFloat(confirmed[172]), "color":chart.colors.getIndex(4) },
  { "id":"QA", "name":"Qatar", "value":parseFloat(confirmed[173]), "color": chart.colors.getIndex(0) },
  { "id":"RO", "name":"Romania", "value":parseFloat(confirmed[175]), "color":chart.colors.getIndex(1) },
  { "id":"RU", "name":"Russia", "value":parseFloat(confirmed[176]), "color":chart.colors.getIndex(1) },
  { "id":"RW", "name":"Rwanda", "value":parseFloat(confirmed[177]), "color":chart.colors.getIndex(2) },
  { "id":"SA", "name":"Saudi Arabia", "value":parseFloat(confirmed[186]), "color": chart.colors.getIndex(0) },
  { "id":"SN", "name":"Senegal", "value":parseFloat(confirmed[187]), "color":chart.colors.getIndex(2) },
  { "id":"RS", "name":"Serbia", "value":parseFloat(confirmed[188]), "color":chart.colors.getIndex(1) },
  { "id":"SL", "name":"Sierra Leone", "value":parseFloat(confirmed[190]), "color":chart.colors.getIndex(2) },
  { "id":"SG", "name":"Singapore", "value":parseFloat(confirmed[191]), "color": chart.colors.getIndex(0) },
  { "id":"SK", "name":"Slovak Republic", "value":parseFloat(confirmed[192]), "color":chart.colors.getIndex(1) },
  { "id":"SI", "name":"Slovenia", "value":parseFloat(confirmed[193]), "color":chart.colors.getIndex(1) },
  { "id":"SB", "name":"Solomon Islands", "value":parseFloat(confirmed[194]), "color":"#8aabb0" },
  { "id":"SO", "name":"Somalia", "value":parseFloat(confirmed[195]), "color":chart.colors.getIndex(2) },
  { "id":"ZA", "name":"South Africa", "value":parseFloat(confirmed[196]), "color":chart.colors.getIndex(2) },
  { "id":"ES", "name":"Spain", "value":parseFloat(confirmed[198]), "color":chart.colors.getIndex(1) },
  { "id":"LK", "name":"Sri Lanka", "value":parseFloat(confirmed[199]), "color": chart.colors.getIndex(0) },
  { "id":"SD", "name":"Sudan", "value":parseFloat(confirmed[200]), "color":chart.colors.getIndex(2) },
  { "id":"SR", "name":"Suriname", "value":parseFloat(confirmed[201]), "color":chart.colors.getIndex(3) },
  { "id":"SZ", "name":"Swaziland", "value":parseFloat(confirmed[203]), "color":chart.colors.getIndex(2) },
  { "id":"SE", "name":"Sweden", "value":parseFloat(confirmed[204]), "color":chart.colors.getIndex(1) },
  { "id":"CH", "name":"Switzerland", "value":parseFloat(confirmed[205]), "color":chart.colors.getIndex(1) },
  { "id":"SY", "name":"Syria", "value":parseFloat(confirmed[206]), "color": chart.colors.getIndex(0) },
  { "id":"TW", "name":"Taiwan", "value":parseFloat(confirmed[207]), "color": chart.colors.getIndex(0) },
  { "id":"TJ", "name":"Tajikistan", "value":parseFloat(confirmed[208]), "color": chart.colors.getIndex(0) },
  { "id":"TZ", "name":"Tanzania", "value":parseFloat(confirmed[209]), "color":chart.colors.getIndex(2) },
  { "id":"TH", "name":"Thailand", "value":parseFloat(confirmed[210]), "color": chart.colors.getIndex(0) },
  { "id":"TG", "name":"Togo", "value":parseFloat(confirmed[212]), "color":chart.colors.getIndex(2) },
  { "id":"TT", "name":"Trinidad and Tobago", "value":parseFloat(confirmed[215]), "color":chart.colors.getIndex(4) },
  { "id":"TN", "name":"Tunisia", "value":parseFloat(confirmed[216]), "color":chart.colors.getIndex(2) },
  { "id":"TR", "name":"Turkey", "value":parseFloat(confirmed[217]), "color":chart.colors.getIndex(1) },
  { "id":"TM", "name":"Turkmenistan", "value":parseFloat(confirmed[218]), "color": chart.colors.getIndex(0) },
  { "id":"UG", "name":"Uganda", "value":parseFloat(confirmed[221]), "color":chart.colors.getIndex(2) },
  { "id":"UA", "name":"Ukraine", "value":parseFloat(confirmed[222]), "color":chart.colors.getIndex(1) },
  { "id":"AE", "name":"United Arab Emirates", "value":parseFloat(confirmed[223]), "color": chart.colors.getIndex(0) },
  { "id":"GB", "name":"United Kingdom", "value":parseFloat(confirmed[224]), "color":chart.colors.getIndex(1) },
  { "id":"US", "name":"United States", "value":parseFloat(confirmed[225]), "color":chart.colors.getIndex(4) },
  { "id":"UY", "name":"Uruguay", "value":parseFloat(confirmed[227]), "color":chart.colors.getIndex(3) },
  { "id":"UZ", "name":"Uzbekistan", "value":parseFloat(confirmed[228]), "color": chart.colors.getIndex(0) },
  { "id":"VE", "name":"Venezuela", "value":parseFloat(confirmed[230]), "color":chart.colors.getIndex(3) },
  { "id":"PS", "name":"West Bank and Gaza", "value":0, "color": chart.colors.getIndex(0) },
  { "id":"VN", "name":"Vietnam", "value":parseFloat(confirmed[231]), "color": chart.colors.getIndex(0) },
  { "id":"YE", "name":"Yemen, Rep.", "value":parseFloat(confirmed[236]), "color": chart.colors.getIndex(0) },
  { "id":"ZM", "name":"Zambia", "value":parseFloat(confirmed[237]), "color":chart.colors.getIndex(2) },
  { "id":"ZW", "name":"Zimbabwe", "value":parseFloat(confirmed[238]), "color":chart.colors.getIndex(2) }
];
  mapData = [
  { "id":"AF", "name":"Afghanistan", "value":parseFloat(confirmed[1]), "color": chart.colors.getIndex(0) },
  { "id":"AL", "name":"Albania", "value":parseFloat(confirmed[2]), "color":chart.colors.getIndex(1) },
...
$.ajax({
           ...
           success:function(result){               
            if(result){
              ...
              //console.log(parseFloat(confirmed_state[36]));
            }
          }
});
